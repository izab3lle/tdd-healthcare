# Sobre o projeto
HealthCare é um projeto desenvolvido com TDD para a cadeira de Gerência de Configuração e Testes. Possui a implementação em Java do módulo de cadastro de um sitema simples de hospital.
...
| ID     | Descrição                                                           | Feito |
|--------|---------------------------------------------------------------------|-------|
| TC_001 | Realizar cadastro de funcionário com sucesso                        | [x]   |
| TC_002 | Realizar cadastro de funcionário com nome vazio                     | [x]   |
| TC_003 | Realizar cadastro de funcionário com email vazio                    | [x]   |
| TC_004 | Realizar cadastro de funcionário com senha vazia                    | [x]   |
...
| TC_007 | Realizar login de funcionário com sucesso                           | [ ]   |
